...
from DuplicateChecker import checker, checkerForForeignKey
# Function to insert fake data into tables


def insert_fake_data(connection, config, table_name, table_data, num_records):
                ...
                for fk in table_data['foreign_keys']:
                    if column_name == fk['fk_column']:
                        ...
                        if values:
                            ...
                            fake_data = checkerForForeignKey(connection, config, table_name, table_data, column_name,
